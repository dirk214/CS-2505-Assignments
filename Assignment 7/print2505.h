...
//	to by data, interpreting the first value with little endian byte 
//	ordering as 0x8800, and interpreting the the second with big endian 
//      with ordering as 0x0084.
//
//	uint8_t data[] = {0x00, 0x88, 0x00, 0x84};
//
//      // prints "Hello	World % 0x8800 0x84", returns 25
